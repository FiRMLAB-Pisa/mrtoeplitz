...
[GitHub's private advisory form](https://github.com/FiRMLAB-Pisa/mrtoeplitz/security/advisories/new).
...
mrtoeplitz is pre-1.0. Fixes land on the default branch and go out in the next
