...
#include <immintrin.h>
#define MRTOEPLITZ_X86_TARGETS 1
#else
#define MRTOEPLITZ_X86_TARGETS 0
#endif
...
namespace
{
    ...
    void packed_hermitian_matvec(py::array values, py::array spectrum, py::array output)
    {
        ...
        parallel_samples(
            batches,
            locations,
            [&](std::size_t batch_begin, std::size_t batch_end, std::size_t begin, std::size_t end)
            {
...
void mrtoeplitz_bind_packed_matvec(py::module_& module)
{
    module.def(
    ...
    module
        .def("sample_thread_count", &sample_thread_count, py::arg("batches"), py::arg("locations"));
}
